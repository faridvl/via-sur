...
const ITEMS = [
  ...
  { href: "/favoritos", etiqueta: "Favoritos", Icono: Heart },
...
export default function BottomNav() {
  ...
  return (
    <nav className="z-50 flex shrink-0 justify-around border-t border-gray-800 bg-gray-900/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-md">
